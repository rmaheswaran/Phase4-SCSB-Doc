...
public class S3SubmitCollectionReportRouteBuilder {
     ...
     */
    @Autowired
    public S3SubmitCollectionReportRouteBuilder(CamelContext context, @Value("${add.s3.routes.on.startup}") boolean addS3RoutesOnStartup, @Value("${s3.submit.collection.report.dir}") String submitCollectionS3ReportPath) {
        try {
