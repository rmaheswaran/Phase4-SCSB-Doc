...
public class S3SubmitCollectionSuccessReportRouteBuilder {
     ...
     */
    @Autowired
    public S3SubmitCollectionSuccessReportRouteBuilder(CamelContext context, @Value("${s3.add.s3.routes.on.startup}") boolean addS3RoutesOnStartup, @Value("${s3.submit.collection.support.team.report.dir}") String submitCollectionS3ReportPath) {
        try {
