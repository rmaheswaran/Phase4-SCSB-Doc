...
public class FSSubmitCollectionSummaryReportGenerator extends CommonReportGenerator implements ReportGeneratorInterface {
    ...
    public boolean isInterested(String reportType) {
        return reportType.equalsIgnoreCase(RecapCommonConstants.SUBMIT_COLLECTION_SUMMARY);
    }
    ...
    public String generateReport(String fileName, List<ReportEntity> reportEntityList) {
        return generateSubmitCollectionReportFile(fileName, reportEntityList, RecapConstants.FS_SUBMIT_COLLECTION_SUMMARY_REPORT_Q);
    }
}
